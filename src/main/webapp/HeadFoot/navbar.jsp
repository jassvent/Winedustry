        ...
        <div class="container-fluid">
            ...
            <div class="offcanvas offcanvas-end text-bg-dark questa-sidebar" tabindex="-1" id="offcanvasDarkNavbar"
                ...
                <div class="offcanvas-body" style="display:flex; align-items:center; justify-content:center;">
                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3 mb-4" style="text-align: center;">
                    	<li style="padding-bottom: 40px;">
                    		<img alt="" src="<%=request.getContextPath()%>/HeadFoot/iconawinedustry.png" style="width: 10%; filter: invert(0%) sepia(100%) saturate(20%) hue-rotate(39deg) brightness(101%) contrast(107%);">
                    	</li>
                        <li class="nav-item" style="margin-bottom:5%;">
                            <a class="link" aria-current="page" href="<%=request.getContextPath()%>/home/home.jsp">Home</a>
                        </li>
                        <li class="nav-item" style="margin-bottom:5%; align-self: center;">
                        	<form action="<%=request.getContextPath()%>/ProdottiServlet" method="post" style="background-color: pink; align-items:center;">
                            	<button class="link" type="submit" style="background-color: #2a2a2a; border:0px;" >Vini!</button>
                            </form>
                        ...
                        <li class="nav-item" style="margin-bottom:5%;">
                            <a class="link" href="<%=request.getContextPath()%>/ContattaciServlet">Contattaci</a>
                        </li>
                        <li>
                            <hr style="color: #b7ac7f; height: 3px; margin-bottom:5%;">
                        </li>
                        <li>
