...
<body class="sfondohome">
	<%@ include file="../HeadFoot/navbar.jsp"%>
		<div class="row" style="margin-right: 0px;">
			...
			<!-- secondo col di 6 -->
			<div class="col-md-6 "
				style="position: relative; display: flex; justify-content: center; align-items:center; text-align: center; margin-bottom:2% ">
				<div class="glassmorfismocartina">
					ì <img src="Cartina_Italia.png"
						style="height: 85vh; width: 35vw; margin-top: 10px;">
				</div>


				<!-- TOOLTIP veneto -->
				<div
					style="position: absolute; top: 10vh; margin-right: 6vw;">
					<link
					...
					<div class="item-hints">
						<div class="hint" data-position="4">
							...
							<div class="hint-content do--split-children glassmorfismo"
								style="width: 600px; height: 100px; display: flex; align-items: center; justify-content: center; padding-left:10px;">
								<img src="<%=request.getContextPath()%>/home/veneto.jpg" style="width: 150px;  border-radius: 10px;
								">
				...
				<div
					style="position: absolute; top: 17vh; margin-right: 10.5vw;">
					<link
						href="https://fonts.googleapis.com/css?family=Ubuntu:300,300i,400,400i,500,500i,700,700i&display=swap"
						rel="stylesheet">
					<div class="item-hints">
						<div class="hint" data-position="4">
							...
							<div class="hint-content do--split-children glassmorfismo"
								style="width: 750px; height: 100px; display: flex; align-items: center; justify-content: center; padding-left:10px;">
								<img src="<%=request.getContextPath()%>/home/emilia.jpg" style="width: 170px;  border-radius: 10px;
								">
				...
				<!-- TOOLTIP toscana -->
				<div
					style="position: absolute; top: 25vh; margin-right: 8vw;">
					<link
						href="https://fonts.googleapis.com/css?family=Ubuntu:300,300i,400,400i,500,500i,700,700i&display=swap"
						rel="stylesheet">
					<div class="item-hints">
						<div class="hint" data-position="4">
							...
							<div class="hint-content do--split-children glassmorfismo"
								style="width: 600px; height: 130px; display: flex; align-items: center; justify-content: center; padding-left:10px;">
								<img src="<%=request.getContextPath()%>/home/toscana.jpg" style="width: 170px;  border-radius: 10px;
								">
				...
				<!-- TOOLTIP puglia -->
				<div
					style="position: absolute; top: 43vh; margin-left: 26vw;">
					<link
						href="https://fonts.googleapis.com/css?family=Ubuntu:300,300i,400,400i,500,500i,700,700i&display=swap"
						rel="stylesheet">
					<div class="item-hints">
						<div class="hint" data-position="4">
							...
							<div class="hint-content do--split-children glassmorfismo"
								style="width: 520px; height: 120px; display: flex; align-items: center; justify-content: center; padding-left:10px;">
								<img src="<%=request.getContextPath()%>/home/puglia.jpg" style="width: 150px;  border-radius: 10px;
								">
				...
				<!-- TOOLTIP sicilia -->
				<div
					style="position: absolute; top: 68vh; margin-left: 10vw;">
					<link
						href="https://fonts.googleapis.com/css?family=Ubuntu:300,300i,400,400i,500,500i,700,700i&display=swap"
						rel="stylesheet">
					<div class="item-hints">
						<div class="hint" data-position="4">
							...
							<div class="hint-content do--split-children glassmorfismo"
								style="width: 620px; height: 110px; display: flex; align-items: center; justify-content: center; padding-left:10px;">
								<img src="<%=request.getContextPath()%>/home/sicilia.jpg" style="width: 170px;  border-radius: 10px;
								">
