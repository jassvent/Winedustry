        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="card" style="margin-left: 20px; box-shadow: rgba(204, 204, 204, 0.35) 0px 5px 15px;">
                    <div class="card-body">
                        <h5 class="card-title text-center"  style="border-bottom: 1px solid rgba(0, 0, 0,0.4); padding-bottom: 10px;"><b>Filtra</b></h5>
                        <form>
                ...
                <% for(Prodotto prodotto : prodotti){ %>
                    <div class="col-md-4 mb-3">
                        <div class="card h-100 glass" style="display: flex; align-items: center; box-shadow: rgba(204, 204, 204, 0.35) 0px 5px 15px;">
                            ...
                            <div class="card-body border-top mt-2 text-center" style="width: 100%;">
                                <h5 class="card-title"><%=prodotto.getNome() %></h5>
                                <p class="card-text">&euro; <%=prodotto.getPrezzo() + "0" %></p>
                            </div>
